...
def _toy_snapshot() -> GameSnapshot:
    ...
    countries = {
        "c1": Country(
            country_id="c1", name="A", continent_id="cont1", tiles=[(0, 0)], centroid=(0, 0)
        ),
        "c2": Country(
            country_id="c2", name="B", continent_id="cont1", tiles=[(0, 1)], centroid=(0, 1)
        ),
        "c3": Country(
            country_id="c3", name="C", continent_id="cont2", tiles=[(0, 2)], centroid=(0, 2)
        ),
    }
    continents = {
        "cont1": Continent(
